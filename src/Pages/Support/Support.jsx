  ...
  return (
    <div className="ds-page">
      <motion.section
        ...
        className="ds-shell"
      >
      <section className="w-full max-w-3xl mx-auto mb-6 text-center">
        <h1 className="ds-title">Submit a Ticket</h1>
        <p className="ds-subtitle">Describe your issue clearly and attach screenshots for faster support.</p>
      </section>
      <form onSubmit={handleSubmit} className="w-full max-w-3xl mx-auto ds-panel p-6 md:p-8 space-y-6">
        ...
        <div className="flex flex-col items-start">
          <label htmlFor="type" className="flex gap-1 text-sm font-medium text-slate-700 mb-2 mr-2">Type <span className="text-red-500">(Required)</span></label>
          <select name="type" id="type" value={formData.type} onChange={handleChange} className="ds-input">
        ...
        <button
          ...
          className={`ds-btn-primary w-full py-3 ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
        >
