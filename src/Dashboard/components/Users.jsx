...
const Users = () => {
  ...
  return (
    <div className="ds-fade-up">
      <section className='flex flex-wrap justify-between items-start gap-4 py-2 w-full mb-4'>
        <div>
          <h2 className="ds-title">Users</h2>
          <p className="ds-subtitle">Manage members, permissions, and account activity.</p>
        </div>
        <button onClick={openModal} className="ds-btn-primary">Add User</button>
      </section>
      <div className="overflow-x-auto md:min-w-full mx-auto h-full ds-panel p-2 sm:p-4">
        <div className="lg:overflow-x-hidden md:min-w-full max-w-[420px] overflow-x-scroll sm:rounded-lg">
          <table className="ds-table lg:min-w-full lg:overflow-x-auto w-fit overflow-x-scroll z-10 bg-white">
            <div className="relative lg:w-[50%] w-full py-2">
              ...
              <input
                type="text"
                className="ds-input block w-full ml-4 py-2.5 pl-8 pr-10 text-sm"
                placeholder="Search..."
                value={searchTerm}
                ...
                <tr>
                  <td colSpan="6" className="px-6 py-12 text-center">
                    <div className="ds-empty">
                      ...
                      <p className="text-sm mt-2">Try another search term or add a new user.</p>
                    </div>
                  </td>
                </tr>
              )}
              {currentUsers.map((user) => (
                <tr key={user.id} className="hover:bg-slate-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap font-['Cairo']">
                    <button className="ds-btn-primary py-2 px-4" onClick={() => { setSelectedUser(user); setShowTicketsModal(true) }}>
                      View
                    </button>
                  </td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium flex gap-2 font-['Cairo']">
                    ...
                    <div className="relative inline-block text-left">
                      <button
                        type="button"
                        className="text-slate-700 bg-white border border-slate-300 hover:bg-slate-100 focus:outline-none font-medium rounded-xl text-sm px-5 py-2.5 inline-flex items-center gap-3"
                        onClick={() => {
