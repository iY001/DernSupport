...
function FloatingSection() {
  ...
  return (
    <div className="relative flex items-center justify-center w-full z-[60]">
      <div className={`fixed bottom-20 right-3 md:right-4 w-[calc(100%-1.5rem)] sm:w-full max-w-sm transition-all ease-in duration-300 ${showChat ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0 pointer-events-none'}`}>
        <Chat embedded />
      </div>
      <button
